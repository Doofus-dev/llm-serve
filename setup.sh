...
echo ""
echo "  3. Add or edit models in ${MODELS_JSON} (or use the TUI):"
echo "     - Set file paths under ${MODELS_DIR}/"
echo "     - Tune gpu_layers, ctx, cache types, and sampling in a preset (E)"
echo "     - Press F2 in the preset editor for parameter help (param-help.conf)"
echo ""
echo "  4. Test it:"
